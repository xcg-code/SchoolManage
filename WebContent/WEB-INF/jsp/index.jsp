        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    <div id="logo">
                        <img src="img/logo/logo-alt.png" height="40" alt="logo name"/>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="login-box-plain">
                        ...
                        <form role="form" method="post" action="login">
                            ...
                            <div class="form-group">
                                <label>职位</label><br>
                                <div class="col-md-8">
                                    <label class="radio-inline"> <input type="radio" class="uniform" name="position"
                                                                        value="0" checked="checked"> 教师 </label>
                                    <label class="radio-inline"> <input type="radio" class="uniform" name="position"
                                                                        value="1">学生</label>
                                </div>
                            </div>
