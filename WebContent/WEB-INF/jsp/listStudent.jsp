				...
				<div class="row">
					<div id="content" class="col-lg-12">
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="page-header">
									...
									<!-- /BREADCRUMBS -->
									<div class="clearfix">
										<h3 class="content-title pull-left">学生管理</h3>
									</div>
									<div class="description">查看学生用户相关信息并进行管理</div>
								</div>
							</div>
						</div>
						<!-- /PAGE HEADER -->
						...
						<div class="box border">
							<div class="box-title">
								<h4>
									<i class="fa fa-user"></i><span class="hidden-inline-mobile">学生信息</span>
								</h4>
							</div>
							<div class="box-body">
												...
												<div class="col-md-12">
													<div class="box-body">
														<table id="datatable1"
															...
															<tbody>
																<c:forEach items="${stuList}" var="c" varStatus="st">
																	<tr>
																		<td>${c.number}</td>
																		<td>${c.name}</td>
																		<td>${c.sex}</td>
